...
import com.unascribed.antiquated.port.adapter.AntiqueBlockAccess;

import net.minecraft.block.Material;
import net.minecraft.entity.Entity;
import net.minecraft.util.math.MathHelper;

public class BetaPathfinder
{

    public BetaPathfinder(AntiqueBlockAccess iblockaccess)
    {
        path = new Path();
    ...
    {
        return createEntityPathTo(entity, entity1.getPos().x, entity1.getPos().y, entity1.getPos().z, f);
    }
            ...
            float f)
    {
        path.clearPath();
        pointMap.clearMap();
        PathPoint pathpoint = openPoint(MathHelper.floor(entity.getBoundingBox().minX), MathHelper.floor(entity.getBoundingBox().minY), MathHelper.floor(entity.getBoundingBox().minZ));
        PathPoint pathpoint1 = openPoint(MathHelper.floor(d - entity.getWidth() / 2.0F), MathHelper.floor(d1), MathHelper.floor(d2 - entity.getWidth() / 2.0F));
        PathPoint pathpoint2 = new PathPoint(MathHelper.floor(entity.getWidth() + 1.0F), MathHelper.floor(entity.getHeight() + 1.0F), MathHelper.floor(entity.getWidth() + 1.0F));
    ...
    private AntiqueBlockAccess worldMap;
    private Path path;

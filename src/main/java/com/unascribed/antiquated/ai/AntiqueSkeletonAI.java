...
public class AntiqueSkeletonAI extends AntiqueMonsterAI {
		...
		if(f < 10F)
		{
			...
			if(attackTime == 0)
			{
				...
				entityarrow.refreshPositionAndAngles(
						entity.getPos().x - MathHelper.cos((entity.yaw / 180F) * 3.141593F) * 0.18F,
						entity.getBodyY(1),
						entity.getPos().z - MathHelper.sin((entity.yaw / 180F) * 3.141593F) * 0.18F,
				...
				entityarrow.setVelocity(d, d2 + f1, d1, 1.0F, 12F);
				attackTime = 30;
			}
